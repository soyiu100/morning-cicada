...
The result is a relatively standard tutorial app covering the basics: from shaders, textures, and the coordinate system.  
...
For this month, I want to the feature the [end executable](https://drive.google.com/uc?export=view&id=1sAW-dk4grgnsJaoJC3mDmAiY5IiCYkh5) resulting from the work over the past month. It features:
- the parts of the tutorial I've covered,
- a bit of test text at the bottom, 
- the console outputs read output from a file located at `src/resources/evil.txt` and
- tests the integration between a Lua script and the app.
